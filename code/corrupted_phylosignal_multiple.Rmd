...
files <- list.files("simulations/selection", full.names = TRUE, pattern = "res_sim_\\d+\\.rds")
...
#saveRDS(df_all_procrustes, here::here("output/df_all_procrustes.rds"))
df_all_procrustes <- readRDS(here::here("output/df_all_procrustes.rds"))
...
#saveRDS(df_mantel, here::here("output/df_mantel.rds"))
...
#saveRDS(jaccard_results, here::here("output/jaccard_results.rds"))
...
# compute mean timestep where max S is reached
